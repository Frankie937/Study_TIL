...
* 주제: LangGraph의 DeepAgents 동작 원리와 구조 파헤치기
  - 핸즈온 튜토리얼 자료를 준비하였습니다.
  - 튜토리얼을 직접 진행하면서 이번에 바뀐 LangGraph V1의 멀티 에이전트 구조로 만든 DeepAgents의 구조를 파헤쳐 봅니다.
  - 이번 DeepAgents는 Claude Code나 Manus에서 차용한 TODO를 통한 Task 관리가 인상적입니다.
  -  TODO 관리 그리고 Context Managing을 위한 File tool 사용 등에 대해 공유해 드릴 예정입니다.
