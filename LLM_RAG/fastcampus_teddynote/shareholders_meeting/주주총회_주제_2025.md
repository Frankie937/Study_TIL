...
* 주제
  - dify 에 파일 업로드 기능 / 파이프라인 설정을 더 편하게 하는 기능 등 새로운 기능 소개
...
* 주제(총 2번의 주주총회)
  - 3/25 (화) 오후 9시: 김정욱님께서 입문자를 위한 dify 강의
  - 3/29 (토) 오후 9시: 테디와 함께 MCP 파헤치기(랭체인노트 기반 MCP 만들고 Cursor AI 에 적용하는 방법 및 노하우)
    

### 2025년 4월 주주총회 (20250429)
* 주제(총 2번의 주주총회)
  * 1부: Agent (MCP~A2A) 톺아보기(진행자: 테디)
    - Agent 의 세부 동작 방식, MCP / A2A 트렌드
...
* (참고)
코딩은 전혀 들어가지는 않지만, docker, supabase 설정 등은 필요한 과정. 구동해 보실 분들은 docker desktop 설치 및 https://supabase.com/ 을 미리 가입해 두시는 것을 권장. 
...
* 주제: LangGraph 최신 기능 QuickTutorial 로 톺아보기
  - LangGraph 핵심 기능만 묶어서 압축된 2~3시간 분량의 짧고 굵은 내용으로 요약 및 정리
  - 2시간 동안 핸즈온 튜토리얼을 같이 진행해 보면서 세부 기능에 대해서 소개 
  - HITL, Command, GOTO, 장단기 메모리 등의 기능을 소개
...
### 2025년 11월 주주총회 (20251129)
* 주제: LangGraph의 DeepAgents 동작 원리와 구조 파헤치기
  - 핸즈온 튜토리얼 자료 준비
  - LangGraph V1의 멀티 에이전트 구조로 만든 DeepAgents의 구조 파헤치기(DeepAgents는 Claude Code나 Manus에서 차용한 TODO를 통한 Task 관리가 인상적)
  - TODO 관리 그리고 Context Managing을 위한 File tool 사용 등에 대해 공유 예정
